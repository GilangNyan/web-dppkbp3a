...
<head>
    ...
    <link rel="icon" href="img/kotatasikmalaya.png">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">TUGAS DAN FUNGSI</a>
                    </li>
    ...
    <!-- CAROUSEL START -->
    <!-- carousel indicator : post trending blog -->
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img style="max-height: 476pt" src="img/1.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img style="max-height: 476pt" src="img/2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-md-block">
                ...
                <div class="carousel-item">
                    <img style="max-height: 476pt" src="img/3.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-md-block">
                ...
                <div class="carousel-item">
                    <img style="max-height: 476pt" src="img/4.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-md-block">
                        <h5>Third slide label</h5>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dicta cum quasi neque earum sint
                            exercitationem aspernatur, commodi officia? Totam quos esse veniam quia alias velit
                            dignissimos dicta facere nesciunt atque.</p>
                    </div>
                </div>
            </div>
            <!-- Next & Previous -->
               ...
               <div class="row mb-1">
                <div class="card mb-2">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="ml-2 mt-2"><h5>Juduulll</h5>
