...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="<?= base_url('admin') ?>" class="nav-link <?= $pagename == 'Beranda' ? 'active' : ''; ?>">
            ...
            <li class="nav-item has-treeview <?= $pagename == 'Semua Tulisan' || $pagename == 'Tulisan Diterbitkan' || $pagename == 'Tambah Tulisan' || $pagename == 'Komentar' || $pagename == 'Pesan Masuk' ? 'menu-open' : ''; ?>">
                ...
                <ul class="nav nav-treeview">
                    <!-- dropdown tulisan -->
                    <li class="nav-item has-treeview ml-3 <?= $pagename == 'Semua Tulisan' || $pagename == 'Tulisan Diterbitkan' || $pagename == 'Tambah Tulisan' || $pagename == 'Komentar' ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link <?= $pagename == 'Semua Tulisan' || $pagename == 'Tulisan Diterbitkan' || $pagename == 'Tambah Tulisan' || $pagename == 'Komentar' ? 'active' : ''; ?>">
