...
class Album extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('blogalbum_model');
    }
    ...
    public function index($tahun, $bulan)
    {
        ...
        $data['album'] = $this->blogalbum_model->getAlbum($tahun, $bulan);
        $data['foto'] = $this->blogalbum_model->getFoto($tahun, $bulan);
    ...
    private function namacard($tahun, $bulan)
    {
        ...
        $judulcard = 'Album bulan ' . $nbulan . ' ' . $tahun;
        return $judulcard;
    }
}
